$(function () {
	...
	if (bodyRtl) {
		...
		(document.getElementById("style")?.setAttribute("href", "../../assets2/plugins/bootstrap/css/bootstrap.rtl.min.css"));
		...
		$("head link#style").attr("href", $(this));
		(document.getElementById("style")?.setAttribute("href", "../../assets2/plugins/bootstrap/css/bootstrap.min.css"));
	};
	// For RTL //	
	// For Horizontal //	
