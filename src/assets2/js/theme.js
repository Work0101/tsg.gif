	...
	*/
	if( $('a[data-bs-toggle="tab"]').length ) {
		$('a[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
			...
			// Carousel Refresh
			if($tabPane.length) {
				$tabPane.find('.owl-carousel').trigger('refresh.1owl.carousel');
			}
	...
	PluginCarousel.prototype = {
		...
		build: function() {
			...
			if( $el.hasClass('nav-outside') ) {
				$(window).on('1owl.carousel.nav.outside', function(){
					if( $(window).width() < 992 ) {
				...
				$(window).on('load', function(){
					$(window).afterResize(function(){
						$(window).trigger('1owl.carousel.nav.outside');
					});
				});
			...
			if( $el.hasClass('carousel-center-active-item') ) {
				...
				// Refresh
				$el.trigger('refresh.1owl.carousel');
			...
			if( $el.find('[data-icon]').length ) {
				$el.on('change.1owl.carousel drag.1owl.carousel', function(){
		...
		carouselNavigate: function() {
			var self      = this,
				$el       = this.options.wrapper,
				$carousel = $el.data('1owl.carousel');
	...
	PluginRandomImages.prototype = {
		...
		perWrapper: function() {
			...
			$wrapper.find('img').each(function(index){
				var $image = $(this),
					animateIn  = $image.data('rimage-1animate-in') ? $image.data('rimage-1animate-in') : self.options.animateIn,
					animateOut = $image.data('rimage-1animate-out') ? $image.data('rimage-1animate-out') : self.options.animateOut,
...
(function(theme, $) {
	...
	PluginRevolutionSlider.defaults = {
	    ...
	    whiteboard: {
	        movehand: {
	            src: '../vendor/rs-plugin/revolution-addons/whiteboard/assets2/images/hand_point_right.png',
	            width: 400,
	            height: 1000,
	            handtype: 'right',
	            transform: {
	        ...
	        writehand: {
	            src: '../vendor/rs-plugin/revolution-addons/whiteboard/assets2/images/write_right_angle.png',
	            width: 572,
	            height: 691,
	            handtype: 'right',
	            transform: {
